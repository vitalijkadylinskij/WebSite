...
export default function CasesPageLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-purple-100 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 transition-colors duration-500">
