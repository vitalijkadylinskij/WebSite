      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        <div className="flex items-center space-x-6">
          ...
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="bg-transperent hover:cursor-pointer font-normal">
                  AI glasses
                </NavigationMenuTrigger>
                <NavigationMenuContent>
        ...
        <div className="flex items-center space-x-4">
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink className="bg-transperent hover:cursor-pointer">
                  Explore Meta
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
