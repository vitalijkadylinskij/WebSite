  ...
  return (
    <section className="w-full py-12 bg-white">
      <div className="container max-w-[80%] mx-auto px-4 md:px-6">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-12 text-left">{t("cases.title")}</h2>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                    ...
                    <div className="mt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-200">
                      <Link
                        ...
                        prefetch={false}
                        className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200"
                      >
                        {t("cases.details")}
                      </Link>
                    </div>
