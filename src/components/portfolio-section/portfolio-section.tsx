...
export default function PortfolioSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-800 relative overflow-hidden transition-colors duration-300">
